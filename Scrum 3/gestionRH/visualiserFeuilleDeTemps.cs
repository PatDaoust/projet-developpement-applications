...
namespace gestionRH
{
    public partial class visualiserFeuilleDeTemps : Form
    {
        ...
        public void remplirTable()
        {
            ...
            dgvFeuillesTempsVisual.DataSource = data;
        }
        ...
        private void buttonValider_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Aucune nouvelle entrée, veuillez ajouter une feuille de temps!", "Erreur Inattendue", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
